...
MyWebFTP to małe narzędzie w PHP, które pozwala na zarządzanie poprzez
przeglądarkę plikami i katalogami znajdującymi się w określonej
przestrzeni WWW. Program ten staje się bardzo przydatny dla
użytkowników znajdujących się za restrykcyjnym proxy, gdyż używa tylko
funkcji PHP.
